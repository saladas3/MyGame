...
private:
    ...
    // This will be the quad used as render target (basically the screen in which we render the game)
    MeshPtr mQuadMesh = nullptr;
    MaterialPtr mPostProcessMat = nullptr;
